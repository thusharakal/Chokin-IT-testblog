                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="background: #e1e1e2;height:120px;padding-top: 16px;">
                        <h2>
                            ...
                            <a href="<?php echo e(url('admin/posts/create')); ?>" class="btn btn-success pull-right">Create New</a>
                        </h2>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sample blog\thusharasblog\resources\views/admin/posts/index.blade.php ENDPATH**/ ?>